...
<qgis version="3.8.3-Zanzibar" simplifyLocal="1" minScale="1e+08" simplifyAlgorithm="0" styleCategories="AllStyleCategories" simplifyMaxScale="1" maxScale="0" readOnly="0" hasScaleBasedVisibilityFlag="0" simplifyDrawingTol="1" labelsEnabled="0" simplifyDrawingHints="0">
  <flags>
    ...
    <symbols>
      <symbol type="marker" clip_to_extent="1" alpha="1" name="0" force_rhr="0">
        <layer pass="0" class="SimpleMarker" locked="0" enabled="1">
          <prop v="0" k="angle"/>
          <prop v="142,204,184,255" k="color"/>
          ...
          <prop v="27,153,111,255" k="outline_color"/>
  ...
  <DiagramLayerSettings placement="0" showAll="1" priority="0" dist="0" zIndex="0" obstacle="0" linePlacementFlags="18">
    <properties>
      <Option type="Map">
        <Option type="QString" value="" name="name"/>
        <Option name="properties"/>
