...
<qgis maxScale="0" simplifyDrawingTol="1" simplifyMaxScale="1" minScale="1e+08" simplifyDrawingHints="0" version="3.8.3-Zanzibar" styleCategories="AllStyleCategories" labelsEnabled="0" simplifyAlgorithm="0" simplifyLocal="1" hasScaleBasedVisibilityFlag="0" readOnly="0">
  <flags>
  ...
  <DiagramLayerSettings showAll="1" linePlacementFlags="18" zIndex="0" priority="0" dist="0" placement="0" obstacle="0">
    <properties>
      <Option type="Map">
        <Option value="" type="QString" name="name"/>
        <Option name="properties"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <widgets/>
  <previewExpression>common_name</previewExpression>
  <mapTip></mapTip>
