...
class APISSite(QDialog, FORM_CLASS):
    ...
    def __init__(self, iface, dbm, imageRegistry, apisLayer, parent=None):
        ...
        aPdfExportSite.triggered.connect(self.exportPdf)  # TODO: use lambda: to send mode
        ...
        aPdfExportSiteFindspotList.triggered.connect(self.exportPdf)  # TODO: use lambda: to send mode
        ...
        aPdfExportSiteFindspotListFindspot.triggered.connect(self.exportPdf)  # TODO: use lambda: to send mode
        ...
        while query.next():
            ...
            for col in range(rec.count()-1): # -1 geometry wird nicht benötigt!
                ...
                if val.replace(" ", "") == '' or val == 'NULL':
                    val = u"---"
                siteDict[str(rec.fieldName(col))] = val
            ...
            mapSettings.setMapUnits(QgsUnitTypes.DistanceMeters)
            ...
            QgsProject.instance().addMapLayer(siteLayer, False)  # False = don't add to Layers (TOC)
            ...
            for itemId in adjustItemHightTxt:
                ...
                if itemTxt:
                    ...
                    displayText = str(itemTxt.displayText())
