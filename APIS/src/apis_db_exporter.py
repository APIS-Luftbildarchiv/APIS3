...
FORM_CLASS, _ = loadUiType(os.path.join(
    os.path.dirname(os.path.dirname(__file__)), 'ui', 'apis_db_exporter.ui'), resource_suffix='')


class APISDbExporter(QDialog, FORM_CLASS):
    def __init__(self, parent=None):
        """Constructor."""
        super(APISDbExporter, self).__init__(parent)
